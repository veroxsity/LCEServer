...
namespace LCEServer
{
    namespace
    {
        ...
        using RedstoneLogic::IsMinimalBlockPoweredAt;
        using RedstoneLogic::GetMinimalComparatorInputSignal;
        using RedstoneLogic::GetMinimalComparatorSideSignal;
        using RedstoneLogic::RefreshMinimalRedstoneAround;
        using RedstoneLogic::CleanupUnsupportedSupportSensitiveBlocksAround;
